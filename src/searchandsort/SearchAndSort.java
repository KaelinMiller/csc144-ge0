...
public class SearchAndSort {
    ...
    /**
     * Finds the index of the first appearance of a given integer in a list using a sequential search algorithm
     * 
    ...
    /**
     * Finds the index of the first appearance of a given value in an ordered list using a binary search algorithm
     * 
